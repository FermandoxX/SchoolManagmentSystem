      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/admin/profile?id=<?= $params['userData']->user_id ?>">Edit Profile</a>
            </li>

            <li class="nav-item">
              <a class="nav-link active" href="/admin/password?id=<?= $params['userData']->user_id ?>">Change Password</a>
            </li>
