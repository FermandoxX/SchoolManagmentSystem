        ...
        <div class="col-lg-12" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
          ...
          <div class="d-flex row gap-5 justify-content-center align-items-center w-100">
            <?php foreach($studentsData as $studentData): ?>
                <div class="col-xl-4" style=" width:275px; height:310px" href="/attendance/add?student_id=<?php echo $studentData->user_id;?>&subject_id=<?= $data['subject_id'] ?>">
                    <div class="card w-100 h-100">
                        <div class="card-body profile-card pt-4 d-flex flex-column justify-content-center align-items-center">
                          ...
                          <div class="d-flex gap-2">
                            <?php if(isTeacher()):?>
                            <a class="editDeleteButton mb-3 mr-3 bg-success text-white" href="/attendance/add?student_id=<?php echo $studentData->user_id;?>&subject_id=<?= $data['subject_id']?>">Add</a>
                            <?php endif;?>
                            <a class="editDeleteButton mb-3 mr-3 bg-danger text-white"  href="/attendance/remove?student_id=<?php echo $studentData->user_id?>&subject_id=<?= $data['subject_id']?>">Delete</a>
                          </div>
                        </div>
                    </div>
                </div>
