      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/student/profile?id=<?= $studentData->user_id ?>">Edit Profile</a>
            </li>

            <li class="nav-item">
              <a class="nav-link active" href="/student/password?id=<?= $studentData->user_id ?>">Change Password</a>
            </li>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active pt-3" id="profile-change-password">
              ...
              <form action="/student/password/update" method="post">
