    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          ...
          <img src="/../image/<?php echo $studentData->image ?>" alt="Profile" class="rounded-circle" width="125" height="125" style="object-fit:cover">
          <h2><?php echo $studentData->name.' '.$studentData->surename?></h2>
          <h3><?php echo ucfirst($studentData->role_name) ?></h3>
      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/student/profile?id=<?= $studentData->user_id ?>">Edit Profile</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/student/password?id=<?= $studentData->user_id ?>">Change Password</a>
            </li>
            ...
            <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
              ...
              <form action="/student/profile/update" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="name" type="text" class="form-control <?php echo isset($params['validation']) && $params['validation']->hasError('name') ? ' is-invalid' : ' ';  ?>" id="Name" value="<?php echo $studentData->name?>" >
                    <input name="userId" type="text" class="form-control" id="userId" value="<?php echo $studentData->user_id?>" style="display:none">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="surename" type="text" class="form-control <?php echo isset($params['validation']) && $params['validation']->hasError('surename') ? ' is-invalid' : ' ';  ?>" id="Surename" value="<?php echo $studentData->surename?>" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="address" type="text" class="form-control <?php echo isset($params['validation']) && $params['validation']->hasError('address') ? ' is-invalid' : ' ';  ?>" id="Address" value="<?php echo $studentData->address?>" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="phone_number" type="text" class="form-control <?php echo isset($params['validation']) && $params['validation']->hasError('phone_number') ? ' is-invalid' : ' ';  ?>" id="Phone" value="<?php echo $studentData->phone_number?>" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="email" type="email" class="form-control <?php echo isset($params['validation']) && $params['validation']->hasError('email') ? ' is-invalid' : ' ';  ?>" id="Email" value="<?php echo $studentData->email?>" >
